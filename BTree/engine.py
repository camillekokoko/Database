    ...
    while True:
        ...
        if command == "exit":
            ...
            if table_name is None:
                ...
                if indexed_columns:
                    #print(f"Index on column {', '.join(indexed_columns)}")
                    for column in indexed_columns:
                        print(f"Index on column {column}")
        ...
        # add code for processing create index and drop index here ...
         # processing create index
            ...
            column_name = command.split()[-1]
            # print('column name:', column_name)
            #db.create_index(column_name)
            message = db.create_index(column_name)
            print(message)
        ...
        # process drop index
            ...
            column_name = command.split()[-1]
            message = db.drop_index(column_name)
            print(message)
