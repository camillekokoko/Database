...
# - used by database systems - large volume of data -> may not fit into primary memory (RAM) [secondary storage SSD]
# - reduce disk operations - disk (I/O is proportional to tree height)
